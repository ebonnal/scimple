...
from scimple.scimple import *

# example :


molecTable = Table("data/phenyl-Fe-porphyirine-CO2-Me_4_rel.xyz", firstLine=3, lastLine=103)
grapheneTable = Table("data/phenyl-Fe-porphyirine-CO2-Me_4_rel.xyz", firstLine=104, lastLine=495)
chargesGraphene = Table("data/CHARGES_phenyl-Fe-porphyirine-CO2-Me_4_rel", firstLine=104, lastLine=495)
...
myTable = Table("data/ek_InTP_CO2_Me_4_graphene_W_r2_k.dat", firstLine=1)
